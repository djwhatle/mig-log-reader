...
CMD sa2kubeconfig.sh && stern --kubeconfig /var/cache/sa2kubeconfig/kubeconfig "migration-controller|migration-ui|registry|restic|velero" --exclude-container discovery --exclude "watch is too old" --tail=0 --color always
